...
public class CancelledOrderAdapter extends RecyclerView.Adapter<com.limkee.order.CancelledOrderAdapter.MyViewHolder> {
        ...
        @Override
        public com.limkee.order.CancelledOrderAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            return new com.limkee.order.CancelledOrderAdapter.MyViewHolder(itemView);
        }

        @Override
        public void onBindViewHolder(final com.limkee.order.CancelledOrderAdapter.MyViewHolder holder, int position) {
